...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    resultNum: null,
    resultUnit: null,
    resultLabel: "CS/CX 담당자로서 문의를 직접 응대하며, 반복 문의 분류와 대응 기준을 정리해 응대 구조를 개선했습니다.",
    verified: "부분검증",
    headline: "고객 문의를 직접 응대하며 반복 문의를 분류하고 자동화/가이드/챗봇 연계를 주도했습니다.",
    summary: "채널톡/전화 등 다양한 채널의 문의를 직접 응대하며 반복 문의를 분류하고 대응 기준을 정리했습니다. 자동화와 가이드 연계를 주도해 팀의 응대 부담을 낮추고 고객 경험이 일관되게 유지되도록 기여했습니다.",
    problemDef: "고객 문의가 많아지며 응대 지연과 팀 피로도가 커졌고, 고객 경험 개선이 필요했습니다.",
    execution: "문의 데이터를 유형화하고 난이도 기반 분기/자동응답/담당자 라우팅 체계를 설계해 주간 개선 루프를 운영했다.",
    result: "반복 문의를 줄이고 응대 품질을 안정화하는 데 기여했습니다. 해외 리서치/개발 팀과 협업 과정에서 한국 사업부를 대표해 커뮤니케이션을 수행했습니다.",
    ...
    images: [],
    approach: "반복 문의를 분류하고 대응 기준을 정리해, 자동화/가이드/챗봇 연계를 주도했습니다. 주간 리뷰에서 태그 분포를 확인하며 챗봇 시나리오와 가이드 링크를 계속 보정했습니다.",
    ...
    candidConnection: "고객 문의를 직접 응대하며 반복 문의를 분류하고 기준을 정리한 경험은, 후보자 상담에서도 고민을 정리하고 더 나은 안내를 제공하는 데 기여할 수 있습니다.",
  },
  {
    ...
    verified: "부분검증",
    headline: "행사 운영 과정에서 참여자 안내/문의 응대를 담당하고, 현장 이슈를 정리해 운영 체크리스트를 개선했습니다.",
    summary: "행사 운영 과정에서 참여자 안내와 문의 응대를 담당했습니다. 현장 이슈를 정리해 운영 체크리스트를 개선하고, 반복 행사에서 같은 준비 흐름을 재사용할 수 있도록 정리했습니다.",
    ...
    candidConnection: "행사 운영에서 참여자를 응대하고 현장 이슈를 정리한 경험은, 후보자와의 소통에서도 상황을 빠르게 파악하고 정리하는 데 기여할 수 있습니다.",
  },
  {
    id: "leanup-si",
    evdId: "EVD--9",
    ...
    resultNum: 5,
    resultUnit: "건",
    resultLabel: "클라이언트 5건을 확보하고, 프로젝트 수행 경험을 교육 사업으로 확장하고 있습니다.",
    verified: "부분검증",
    headline: "바이브코딩 기반 소규모 SI 프로젝트를 수행하고, 교육 사업으로 확장하고 있습니다.",
    summary: "바이브코딩으로 웹사이트 제작은 쉬워졌지만 여전히 전문가의 도움이 필요한 구간이 있다고 느꼈습니다. 소규모 SI 프로젝트를 수행하며 클라이언트 5건을 확보했고, 이 경험을 교육형 프로그램으로 재정리하고 있습니다.",
    ...
    result: "클라이언트 5건을 확보해 프로젝트를 운영하고 있습니다. 진행 과정에서 재요청과 확장 논의가 이어지며 교육 사업으로의 확장 가능성을 검증하고 있습니다.",
    ...
    candidConnection: "클라이언트와 소통하며 요구사항을 정리하고 실행한 경험은, 기업과 후보자 사이에서 정보를 정리해 전달하는 데 기여할 수 있습니다.",
  },
  {
    id: "leanup-edu",
    evdId: "EVD--10",
    ...
    verified: "부분검증",
    headline: "누구나 바이브코딩을 시작할 수 있는 교육 프로그램을 운영하고 있습니다.",
    summary: "커리큘럼 설계, 세션 운영, 참여자 질문 응대와 진도 관리를 담당했습니다. 실습 기반으로 학습자가 결과물을 남기도록 설계하고, 반복 운영이 가능한 구조로 정리하고 있습니다.",
    ...
    category: "Content / Community",
    candidConnection: "교육 프로그램에서 학습자를 응대하고 진도를 관리한 경험은, 구직자의 준비 과정을 정리하고 다음 행동을 구체화하는 데 기여할 수 있습니다.",
  },
  {
    id: "data-dashboard",
    evdId: "EVD--2",
    ...
    resultNum: 7,
    resultUnit: "건",
    resultLabel: "7개 부서 데이터를 통합 기준으로 연결해 전사 대시보드 운영 체계를 구축했습니다.",
    verified: "부분검증",
    headline: "해외 리서치/개발 팀과 협업하며, 부서 데이터를 공통 기준으로 통합해 운영 지표를 정리했습니다.",
    summary: "해외 리서치/개발 팀과 협업하며 한국 사업부를 대표해 요구사항을 정리하고 전달했습니다. 운영 지표를 정리해 팀이 같은 화면으로 현황을 파악할 수 있게 했습니다.",
    ...
    category: "Analytics",
    candidConnection: "여러 부서의 데이터를 공통 기준으로 정리한 경험은, 채용 과정에서 후보자와 기업의 정보를 이해하기 쉬운 형태로 정리하는 데 기여할 수 있습니다.",
  },
  {
    ...
    verified: "부분검증",
    headline: "반복 업무를 자동화 가능한 단위로 나누고, 실행 흐름을 정리했습니다.",
    ...
    candidConnection: "반복 업무를 정리하고 자동화한 경험은, 채용 운영에서 반복되는 질문/이슈를 묶어 운영 부담을 줄이는 데 기여할 수 있습니다.",
  },
  {
    id: "ux-guide-chatbot",
    evdId: "EVD--4",
...
export const heroNarratives: HeroNarrative[] = [
  {
    id: "NAR--6",
    name: "자기소개30초",
    keyLine: "학교와 실무를 병행하며 사람·고객·팀을 상대하는 일을 해왔습니다.",
    webSummary: "학교와 실무를 병행하며 제한된 시간 안에서 우선순위를 세우고, 필요한 일을 끝까지 완수하는 법을 배웠습니다. 그 과정에서 주니어/인턴이 느끼는 고민을 가까이서 이해하게 되었고, 이를 바탕으로 더 나은 준비와 선택을 돕고 싶습니다.",
  },
  {
    id: "NAR--7",
    name: "자기소개90초",
    keyLine: "현장에서 고객/팀과 부딪히며 생기는 문제를 정리하고, 실행 가능한 형태로 바꾸는 일을 해왔습니다.",
    webSummary: "고객 문의 응대, 행사 운영, 데이터 정리 등 현장의 반복 문제를 정리하며 일해 왔습니다. 주어진 조건 안에서 우선순위를 세우고 실행하는 방식으로 팀에 기여해 왔습니다.",
  },
  {
    id: "NAR--11",
    name: "창업동기",
    keyLine: "바이브코딩으로 제작은 쉬워졌지만, 여전히 전문가의 도움이 필요한 구간이 있다고 느꼈습니다.",
    webSummary: "바이브코딩이 확산되면서 제작 속도는 빨라졌지만, 실제로 필요한 사람들에게는 여전히 도움이 필요한 영역이 남아 있었습니다. 소규모 SI와 교육 사업을 통해 그 간극을 줄이고 있습니다.",
  },
];
