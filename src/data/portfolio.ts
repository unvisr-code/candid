...
export const heroNarratives: HeroNarrative[] = [
  {
    id: "NAR--6",
    name: "자기소개30초",
    keyLine: "사람을 만나고, 상황을 이해하고, 필요한 정보를 연결하는 일을 해왔습니다.",
    webSummary: "CX 응대, 행사 운영, 데이터 정리, SI 프로젝트 — 역할은 달랐지만 핵심은 같았습니다. 상대의 상황을 빠르게 파악하고, 흩어진 정보를 정리해서, 필요한 형태로 전달하는 것. 이 방식을 채용 상담 현장에서 쓰고 싶습니다.",
  },
  {
    id: "NAR--7",
    name: "자기소개90초",
